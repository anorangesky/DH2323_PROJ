...
// TODO2: (Added by Agnes) Why do we have 4 light-sources? (one for each wall) (check description in "implementation notes/phong") (change to 100px when moving around)
vec3 SpecularComponent(const Intersection& i) {
